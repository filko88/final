...
const defaultOgImage = `${baseUrl}/images/Rep-Finds-app.png`
...
const pageMetadata: Record<PageMetadataKey, PageMetadataEntry> = {
  home: {
    title: "Rep-Finds | Rep spreadsheet alternative for rep finds & QC photos",
    description:
  ...
  finds: {
    title: "Rep Finds Browser | Rep-Finds rep spreadsheet with QC photos",
    description:
  ...
  spreadsheet: {
    ...
    description:
      "Open the Rep-Finds spreadsheet of the best replica finds with QC photos, trusted agent links, and batch notes updated daily.",
    path: "/spreadsheet",
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: "Rep-Finds rep spreadsheet and rep finds",
        },
      ],
    },
    twitter: {
