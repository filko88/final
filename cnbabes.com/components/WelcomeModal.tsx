...
export function WelcomeModal() {
  ...
  useEffect(() => {
    ...
    const hasVisited = localStorage.getItem("CNBabes-has-visited")
    if (!hasVisited) {
  ...
  const closeAndMarkVisited = () => {
    localStorage.setItem("CNBabes-has-visited", "true")
    setIsOpen(false)
  }
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      (window as Window & typeof globalThis & { resetWelcomeModal?: () => void }).resetWelcomeModal = () => {
        localStorage.removeItem("CNBabes-has-visited")
      }
              ...
              {step === "support" ? (
                ...
                <>
                  ...
                  <div className="text-[11px] text-zinc-500">
                    By using CNBabes, you agree to our{" "}
