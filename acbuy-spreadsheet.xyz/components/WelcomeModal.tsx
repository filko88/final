...
export function WelcomeModal() {
  ...
  useEffect(() => {
    ...
    const hasVisited = localStorage.getItem("acbuy-spreadsheet-has-visited")
    if (!hasVisited) {
  ...
  const closeAndMarkVisited = () => {
    localStorage.setItem("acbuy-spreadsheet-has-visited", "true")
    setIsOpen(false)
  }
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      (window as Window & typeof globalThis & { resetWelcomeModal?: () => void }).resetWelcomeModal = () => {
        localStorage.removeItem("acbuy-spreadsheet-has-visited")
      }
              ...
              {step === "support" ? (
                ...
                <>
                  ...
                  <div className="text-[11px] text-zinc-500">
                    By using acbuy-spreadsheet, you agree to our{" "}
