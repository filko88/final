      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] p-0 text-[hsl(var(--sidebar-foreground))] [&>button]:hidden"
            style={
              {
            ...
            side={side}
          >
            <div className="flex h-full w-full flex-col bg-[hsl(var(--sidebar-background))]">
              {children}
            </div>
          </SheetContent>
        </Sheet>
...
const SidebarMenuButton = React.forwardRef<
  ...
  React.ComponentProps<"button"> & {
    asChild?: boolean
    isActive?: boolean
    // Deprecated: tooltips removed. Kept for backward compat; no effect.
...
>(
  ...
  const { isMobile, setOpenMobile } = useSidebar()
    ...
    // Tooltips disabled; render bare button
    return button
  }
)
