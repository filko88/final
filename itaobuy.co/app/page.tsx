...
export default function Home() {
  ...
  const faqItems = [
    {
      question: "What is Rep-Finds?",
      answer: "Rep-Finds is the best rep spreadsheet alternative. It's a tool that helps you not only find the best rep finds but also check the QC photos from top agents like Acbuy, CNFans, Kakobuy, and Oopbuy.",
    },
    {
      question: "Why did we create Rep-Finds?",
      answer: "We created Rep-Finds because we were tired of manually searching for the best rep finds and checking the QC photos. We wanted to create a tool that would help you find the best rep finds and check the QC photos from top agents like Acbuy, CNFans, Kakobuy, and Oopbuy.",
    },
    {
      question: "Which agents and platforms does Rep-Finds support?",
      answer: "Rep-Finds currently supports 4 agents: Acbuy, CNFans, Kakobuy, and Oopbuy. We think that's enough for now. If you want to see more agents, please let us know.",
    },
  ]
    ...
    <div className="bg-background text-foreground font-sans overflow-x-hidden min-h-screen" suppressHydrationWarning={true}>
      ...
      <section className="relative py-10 w-full max-w-[1920px] mx-auto px-4 sm:px-8 bg-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12 relative">
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">How Rep-Finds Works</h2>
